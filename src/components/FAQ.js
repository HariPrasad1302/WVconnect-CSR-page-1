...
const FAQComponent = () => {
  return (
    <div className="bg-white p-4 sm:p-8 md:p-12 lg:p-16 rounded-lg shadow-md">
      <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold mb-2 sm:mb-4 lg:mb-6">
        FAQ
      </h1>
      <h2 className="text-lg sm:text-xl lg:text-2xl text-gray-600 mb-4 sm:mb-6 lg:mb-8">
