...
const Genesis = () => {
    return (
        <div className="flex flex-col lg:flex-row items-center justify-center p-4 bg-gray-100 p-12 py-12">
            {/* Left Part */}
            <div className="lg:w-1/2 lg:pr-11 relative left-6">
                <h2 className="text-4xl lg:text-6xl font-bold text-center lg:text-left mb-4 ml-16 md:mb-6">
                    WV Connect: The Genesis
                </h2>
                <p className="text-base lg:text-2xl text-center ml-16 lg:text-left">
            ...
            {/* Right Part */}
            <div className="lg:w-1/2 mt-4 mr-20 lg:mt-11 lg:mb-9"> 
                <img
